...
if featag
   ...
   save -v7.3 rgbdfea_rgb_rgbkdes rgbdfea rgbdclabel rgbdilabel rgbdvlabel rgbdwords G;
else
...
if category
   ...
   for i = 1:trail
       ...
       save('./results/rgb_rgbkdes_acc_c.mat', 'acc_c', 'predictlabel', 'testlabel', 'decvalues');
