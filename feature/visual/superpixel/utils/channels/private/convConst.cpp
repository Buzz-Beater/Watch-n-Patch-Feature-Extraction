...
void mexFunction( int nlhs, mxArray* plhs[], int nrhs, const mxArray* prhs[] ) {
  int ns[3], ms[3], nDims, d, m, r, s; float *A, *B, p;
  mwSize *temp, temp1[3];
  ...
  temp = (mwSize*) mxGetDimensions(prhs[1]);
  ns[0] = temp[0]; ns[1] = temp[1]; ns[2] = temp[2];
  d = (nDims == 3) ? ns[2] : 1;
  ...
  temp1[0] = ms[0]; temp1[1] = ms[1]; temp1[2] = ms[2];
  plhs[0] = mxCreateNumericMatrix(0, 0, mxSINGLE_CLASS, mxREAL);
  mxSetData(plhs[0], B); mxSetDimensions(plhs[0],(mwSize*)temp1,nDims);
