...
for idx = 1 : 3  
    ...
    for dir_idx = 1 : params.dir_skip : length(im_dirs)
        ...
        savedir = fullfile(rt_dir, 'kdes', 'grad_rgb', im_class{double(idx > 1) + 1});
...
for idx = 1 : length(kdes_path)
    ...
    %}
    save -v7.3 rgbdfea_rgb_gradkdes rgbdwords;
end
%rmdir('~/Projects/WNP-Preprocess/Dataset/kdes/grad_rgb', 's');
